        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 shadow-md space-y-8">
            ...
            <p className="text-lg leading-relaxed text-gray-800">
              ...
              and tradespeople in mind. Homeowners get quotes for their job
              quickly and easily, while tradespeople are able to find local work
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg leading-relaxed text-gray-800">
                Started in 2013, MyTradesLink’s two founders began as a small
                digital marketing company and took inspiration from their
                parents who were both tradespeople. They wanted to create a
                service integrating their digital marketing knowledge to provide
                value for both homeowners and tradespeople.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside text-lg space-y-2 text-gray-800">
                <li>
                  Customer submits information outlining the job they want
                  completing.
                </li>
                <li>
                  The job is checked by MyTradeLinks staff to ensure
                  authenticity.
                </li>
                <li>
                  The job is sent to local tradespeople suitable for the job.
                </li>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside text-lg space-y-2 text-gray-800">
                <li>
                  MyTradeLinks is free to use and allows you to gather multiple
                  quotes with a quick form detailing your job.
                </li>
                <li>Read reviews of trades from other homeowners.</li>
                <li>Compare quotes on price and quality of tradespeople.</li>
                <li>
                  Tradespeople are verified with official ID, email, phone,
                  insurance, and qualifications where required.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside text-lg space-y-2 text-gray-800">
                <li>
                  We directly market to customers seeking work in your area.
                </li>
                <li>
                  Unlike directories, we provide job leads with measurable ROI.
                </li>
                <li>
                  Flexible membership packages depending on jobs in your area.
                </li>
                <li>Free trial available before committing.</li>
                <li>Access to 25,000+ job leads a month.</li>
                <li>
                  Profitable return on investment compared to traditional
                  marketing methods.
                </li>
              </ul>
            </div>
