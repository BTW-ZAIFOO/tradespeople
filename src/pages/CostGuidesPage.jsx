  ...
  const indoorCategories = [
    {
      title: "Bathrooms",
      description:
        "Find out how much bathroom renovations, installations, and repairs cost",
      guides: [
    ...
    },
    {
      ...
      description:
        "Discover the costs for carpentry work, window and door installations",
      guides: [
    ...
    },
    {
      title: "Conversions",
      description:
        "Learn about loft conversions, extensions, and other home conversions",
      guides: [
    ...
    },
    {
      title: "Kitchens",
      description:
        "Get pricing information for kitchen renovations and installations",
      guides: [
        "Kitchen Installation Cost",
        "Kitchen Worktop Cost",
        "Kitchen Cabinet Cost",
    ...
    },
    {
      ...
      description:
        "Find costs for electrical work, rewiring, and lighting installations",
      guides: [
        "House Rewiring Cost",
    ...
    },
    {
      ...
      description:
        "Discover flooring installation costs and carpet fitting prices",
      guides: [
    ...
    },
    {
      ...
      description:
        "Get pricing for plumbing work and heating system installations",
      guides: [
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            We compare dozens of quotes nationwide to provide average prices for
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {indoorCategories.map((category, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 ${category.bgColor} rounded-lg flex items-center justify-center mb-4 text-2xl`}
                >
                  {category.image}
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Complete guide to kitchen installation costs including
                materials, labor, and additional expenses.
              </p>
              <a
                href="#"
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Comprehensive breakdown of bathroom renovation costs from budget
                to luxury installations.
              </p>
              <a
                href="#"
                className="text-blue-600 hover:text-blue-700 font-medium text-sm"
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Everything you need to know about loft conversion costs
