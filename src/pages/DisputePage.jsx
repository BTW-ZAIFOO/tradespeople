        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              If you're experiencing issues with a completed job, please provide
              details below.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("tradespeople", e.target.value)
                    }
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <ul className="text-blue-800 space-y-2 text-sm">
              <li>
                • Our support team will review your dispute within 5-7 business
                days
              </li>
              <li>
                • We may contact you or the tradesperson for additional
                information
              </li>
