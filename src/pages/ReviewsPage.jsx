          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded shadow-sm py-6 px-3">
              ...
              <div className="mt-6 pt-6 border-t border-gray-300 text-center text-sm text-gray-600">
                <p>
                  The more positive reviews you receive, the more work you win!
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white flex items-center gap-4 mb-3 shadow-sm overflow-x-auto">
              <button
                ...
                className={`py-5 px-6 font-medium cursor-pointer ${
                  activeTab === "awaiting"
                  ...
                  <div>
                    <div className="mb-6">
                      <p className="text-gray-700 mb-4">
                        Ask your customers for a reference on work that you've
                        carried out recently outside of MyTradeLinks. You can
                        ask upto 5 customers for a reference and we will display
                        2 on your profile.
                      </p>
                      <p className="text-gray-700 mb-6">
                        Your references should not be from friends or family.
                      </p>
                      <button className="px-6 py-3 mt-6 bg-blue-500 text-white font-semibold hover:bg-blue-600 transition cursor-pointer">
                        Request Review
                      </button>
                    </div>
                  </div>
                ...
                {activeTab === "awaiting" && (
                  <div className="text-center py-12">
                    <p className="text-gray-600">
                      No reviews awaiting at the moment.
                    </p>
                  </div>
                )}
