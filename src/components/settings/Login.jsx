    ...
    <div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-6">
        <div className="flex items-center justify-between">
          ...
          <button className="px-6 py-2 border border-orange-500 text-orange-500 font-semibold rounded-lg hover:bg-orange-50 transition">
            Change Email
          </button>
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-6 py-2 border border-orange-500 text-orange-500 font-semibold rounded-lg hover:bg-orange-50 transition"
          >
            Change Password
          </button>
        </div>
        ...
        {showChangePassword && (
          <form onSubmit={handleChangePassword} className="mt-6 pt-6 border-t border-gray-200">
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-gray-700">Two-Factor Authentication</h3>
            <p className="text-gray-600 mt-2">
              {loginData.twoFactorEnabled ? 'Enabled' : 'Disabled'} - Extra security for your account
            </p>
          </div>
          <button className="px-6 py-2 border border-orange-500 text-orange-500 font-semibold rounded-lg hover:bg-orange-50 transition">
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        ...
        <button className="mt-4 text-orange-500 hover:text-orange-600 font-semibold text-sm">
