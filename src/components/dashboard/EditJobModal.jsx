        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
            <div className="bg-white rounded-lg shadow-lg w-[90%] sm:w-[400px] p-6 relative">
                ...
                <div className="flex flex-col gap-3 mt-4">
                    <button
                        className="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-left"
                    >
                        Edit Job Details
                    </button>
                    ...
                    <button
                        className="px-4 py-2 bg-red-100 hover:bg-red-200 rounded-md text-left text-red-600"
                    >
                        Delete Job
                    </button>
                </div>
