    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
        ...
        <form onSubmit={handleSubmitCode} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="w-full sm:w-auto px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg transition"
          >
            Submit code
          </button>
        </form>
      ...
      {/* Claimed Promotions Table */}
      <div className="bg-white rounded-lg shadow-sm p-8">
        <h3 className="text-lg font-semibold text-gray-800 mb-6">Claimed Promotions</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-100 border-b border-gray-200">
                  <th className="text-left px-4 py-3 font-semibold text-gray-700">Promotion</th>
              ...
              <tbody>
                {appliedPromotions.map((promo) => (
                  <tr key={promo.id} className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="px-4 py-3 text-gray-600">{promo.promotion}</td>
