...
const FindLocationPage = () => {
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left: Text Content */}
            <div>
              <h1 className="font-extrabold mb-4 leading-tight text-4xl" style={{ color: "rgb(80, 85, 102)" }}>
  ...
  />
  <button className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2 bg-[#40D4E8] text-white font-semibold rounded-md hover:bg-[#00A896] transition">
    Get Started
  </button>
</div>
  ...
  <div className="ml-2">
    <p className="font-bold text-[#505566] flex items-center gap-1">
      ...
      <Tradespeople locationName={locationData.name} tradespeople={locationData.tradespeople || []} />
